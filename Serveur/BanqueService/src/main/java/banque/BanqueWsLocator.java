...
public class BanqueWsLocator extends org.apache.axis.client.Service implements banque.BanqueWs {
    ...
    public banque.BanqueService getBanqueServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            main.java.banque.BanqueServicePortBindingStub _stub = new main.java.banque.BanqueServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (banque.BanqueService.class.isAssignableFrom(serviceEndpointInterface)) {
                main.java.banque.BanqueServicePortBindingStub _stub = new main.java.banque.BanqueServicePortBindingStub(new java.net.URL(BanqueServicePort_address), this);
                _stub.setPortName(getBanqueServicePortWSDDServiceName());
                return _stub;
            }
        }
